...
class BurgerIngredients extends Component<IProps> {
    ...
    render() {
        ...
        return  <article className={`${burgerIngredientsStyle.content} pt-10`}>
            <h3 style={{ fontSize: '40px' }} className={`${burgerIngredientsStyle.title} text text_type_main-large mb-5`}>
                Соберите бургер
            </h3>
            ...
            <section className={ burgerIngredientsStyle.list } style={{ maxHeight: '700px', overflowY: 'scroll' }}>
                {
                    this.tabs.map(tab => 
